...
public class GroupContributionEditActivity extends AppCompatActivity {

    @BindView(R.id.contributionedit_toolbar)
    Toolbar mToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_contribution_edit);
