 ...
 */
public class GroupContributionViewModel extends AndroidViewModel {
    ...
    public GroupContributionViewModel(@NonNull Application application,FirebaseAuth mAuth, FirebaseFirestore mFirestore) {
