 ...
 */
public class GroupInviteViewModel extends AndroidViewModel {
    ...
    public GroupInviteViewModel(@NonNull Application application,FirebaseAuth mAuth, FirebaseFirestore mFirestore) {
